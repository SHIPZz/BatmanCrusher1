public class Constant
{
    ...
    public const string ShadePrefab = "Prefabs/Shade";
    public const string ToadStoolPrefab = "Prefabs/ToadStool";
    public const string PlayerHealthBar = "Prefabs/PlayerHealthBar";
    public const string SpiderPricePrefab = "Prefabs/SpiderPrice";
    public const string WolverinePricePrefab = "Prefabs/WolverinePrice";
    public const string GoldRewardType = "Gold";
    public const string ChestRewardType = "Chest";
    public const string PurpleSpider = "Prefabs/PurpleSpider";
}